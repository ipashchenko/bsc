...
class Gains {
    public:
        ...
        // FIXME: Gains should not have methods like ``from_prior_hp...`` because some gains (e.g. ConstantGain) have
        // no hyperparameters.
        // Wrap all from_priors and optional matrix calculations
