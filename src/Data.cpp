...
void Data::load(const char* filename)
{
    ...
    // Vector of the unique STOKES numbers
    stokes_unique.insert(stokes_unique.end(), stokes.begin(), stokes.end());
    std::set<int> ss(stokes_unique.begin(), stokes_unique.end());
    stokes_unique.assign(ss.begin(), ss.end());

    // Vector of the unique IF numbers
    IF_unique.insert(IF_unique.end(), IF.begin(), IF.end());
    std::set<int> sss(IF_unique.begin(), IF_unique.end());
    IF_unique.assign(sss.begin(), sss.end());
